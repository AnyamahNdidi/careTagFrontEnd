    ...
    <Box className='allCon'>
        ...
        <Box className="box2">
            <Box className="cardSign">
                <Box className='formTitle'><Typography>Admin Login</Typography></Box>
          ...
          />
                  ...
                  <Box className="dbut">
                    <GlobalButton>Log In</GlobalButton>
                  </Box>
                
                </form>
                <Box className='alCon'>
                    <Box className='alCondata'>
                        <Box className="alreadyCon"> <Typography>Don't Have An Account,</Typography></Box>
                        <Box className='conLog'
                        onClick={()=>{
                            myNavigation("/sign")
                          }}
                        ><Typography>Register</Typography></Box>
                    </Box>
                </Box>
