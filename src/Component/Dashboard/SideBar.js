                   ...
                   <Box className='dUserCon'>
                        <Box className='dUserConData'>
                            ...
                            <Box className='nameCon'>
                                      ...
                                      <Box className='contentCon'><Typography>{user?.organizationName}</Typography></Box>
                            </Box>
                              ...
                              <Box className='AllMenu'>
                                  ...
                                  <Box className='navMenu'  >
                                      <Box className="bothHolder">
                                          ...
                                          <Box className='typeCon'> <Typography>All Agent</Typography></Box>
                                      </Box>
                                      </Box>
                                  </Link>
                                  <Link to="/agentadd" style={{textDecoration:"none"}}>
                                  <Box className='navMenu'     >
                                      <Box className="bothHolder">
                                          <Box className='navIcon'><AddCardIcon className="iicon"/></Box>
                                          <Box className='typeCon'> <Typography>Add Agent</Typography></Box>
                                      </Box>
                                      </Box>
                                </Link>
                                  <Box className='navMenu'
                                  ...
                                  >
                                      <Box className="bothHolder">
                                          <Box className='navIcon'><SupportAgentIcon className="iicon"/></Box>
                                          <Box className='typeCon'> <Typography>Active Agent</Typography></Box>
                                      </Box>
                                  </Box>
                                  <Box className='navMenu'
                                     onClick={() =>
                                  ...
                                  >
                                      <Box className="bothHolder">
                                          <Box className='navIcon'><BookmarksIcon className="iicon"/></Box>
                                          <Box className='typeCon'> <Typography>Total Customer</Typography></Box>
                                      </Box>
                                  </Box>
                                  <Box className='navMenu'>
        ...
        (
                      <Box className='SecondBox'>
                          <Box>
                              ...
                              <Box className='secondConIcon'>
                                  <Box className='secondIcon'><SupportAgentIcon className="iicon"/></Box>
                              </Box>
                              <Box className='secondConIcon'>
                                  <Box className='secondIcon'><BookmarksIcon className="iicon"/></Box>
                              </Box>
                              <Box className='secondConIcon'>
                                  <Box className='secondIcon'><LogoutIcon  className="iicon"/></Box>
                              </Box>
