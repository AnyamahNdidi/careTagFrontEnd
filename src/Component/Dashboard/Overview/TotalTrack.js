      ...
      <Box className={classes.root}>
          <Box className='box1'>
              <Box className='holderBox'>
                  ...
                  <Box className='figureCon'>
                      <Box className='textC'><Typography>15</Typography></Box>
                      <Box className='textCon'><Typography>Total Number Of Agent</Typography></Box>
                  </Box>
              </Box>
          </Box>
          <Box className='box2'>
          ...
          <Box className='box3'>
               <Box className='holderBox'>
                  ...
                  <Box className='figureCon'>
                      <Box className='textC'><Typography>4</Typography></Box>
                      <Box className='textCon'><Typography>Active Agent</Typography></Box>
                  </Box>
              </Box>
          </Box>
          <Box className='box4'>
               <Box className='holderBox'>
                  ...
                  <Box className='figureCon'>
                      <Box className='textC'><Typography>345</Typography></Box>
                      <Box className='textCon'><Typography>Total Customer</Typography></Box>
                  </Box>
              </Box>
          </Box>
